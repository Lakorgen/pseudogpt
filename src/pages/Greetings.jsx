    ...
    <>
      {promptPreloaderValue ? (
        ...
        <div className='grid place-content-center h-full'>
          <h2
            className='text-headlineLarge font-semibold text-center tracking-tight
        ...
        '
          >
            <motion.span
              ...
              className='bg-gradient-to-r from-teal-400 from-0% via-cyan-500 via-[56%] to-transparent to-75% bg-[length:350%_100%]
